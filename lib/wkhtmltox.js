...
function wkhtmltox() {
    ...
    var maxWorkers = 3; // os.cpus().length * 1.5; make this configurable, limit to 3 for travis-ci
    ...
    function launchWorker() {
        return spawn("/bin/sh", [ "-c", [ self.wkhtmltopdf, "--quiet", "--read-args-from-stdin" ].join(" ") ]);
    }
